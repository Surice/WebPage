<html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <link rel="stylesheet" type="text/css" href='./mcCraftingGuideS.css'>
    ...
    <body>
        ...
        <div class="elements">
            <div class="input-values">
                ...
                <button onclick="calculate()" class="btn-me">Calculate</button>
            </div>

            <div class="li-results">
                <div class="li-results-module">
    ...
    <script>
    for (i in stor){
        document.getElementById('sel-item').innerHTML += `<option>${i}</option>`
    }
