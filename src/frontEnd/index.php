        ...
        <section id="intro">
            ...
            <span>
                <div class="intro-txt">
                    ...
                    <p>Here i will post whatever comes into my mind</p>
                </div>
                <br>
                <table class="intro-table">
                    <tr class="intro-table-head">
                        <td><strong>First some Informations about me&nbsp;</strong></td>
                    </tr>
                    <br>
                    <tr>
                    ...
                    <br>
                    <tr>
                        <td>> i always love to work on the computer, imrpove my coding skills, learn about new Windows
                            features or just play Computergames</td>
                    </tr>
                    <br>
                    <tr>
